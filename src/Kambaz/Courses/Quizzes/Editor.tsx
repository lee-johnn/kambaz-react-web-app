...
export default function QuizEditor() {
  ...
  const [quizData, setQuizData] = useState({
    ...
    showCorrectAnswersDate: formatDateForInput(
      quiz?.showCorrectAnswersDate || now
    ),
  ...
  return (
    <div>
      ...
      {activeTab === "details" && (
        <QuizDetailEditor quizData={quizData} setQuizData={setQuizData} />
      )}
      {activeTab === "questions" && (
        <QuestionEditor quizData={quizData} setQuizData={setQuizData} />
      )}
    </div>
  );
}
